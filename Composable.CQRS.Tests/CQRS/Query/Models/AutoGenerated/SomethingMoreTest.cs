...
{
    [TestFixture]
    public class SomethingMoreTest
    {
        ...
        public void CreateContainer()
        {
            ...
            _container.Register(
                ...
                Component.For<IDocumentDbReader>().ImplementedBy<QueryModelGeneratingDocumentDbReader>()
                    .LifestyleScoped(),
    ...
    namespace Domain
    {
        ...
        public class MyAccount : AggregateRoot<MyAccount, IAccountEvent>
        {
            public MyAccount()
            {
        ...
        namespace Events
        {
            ...
            namespace Implementation
            {
                ...
                public class EmailChangedEvent : AggregateRootEvent, IEmailChangedEvent
                {
                ...
                public class AccountDeletedEvent : AggregateRootEvent, IAccountDeletedEvent
                {
