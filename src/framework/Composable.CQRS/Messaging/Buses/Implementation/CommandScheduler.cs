...
namespace Composable.Messaging.Buses.Implementation
{
    class CommandScheduler : IDisposable
    {
        ...
        public void Schedule(DateTime sendAt, BusApi.Remote.ExactlyOnce.ICommand message) => _guard.Update(() =>
        {
        ...
        class ScheduledCommand
        {
            ...
            public BusApi.Remote.ExactlyOnce.ICommand Command { get; }

            public ScheduledCommand(DateTime sendAt, BusApi.Remote.ExactlyOnce.ICommand command)
            {
