...
namespace CQRS.Tests.CQRS.EventSourcing.EventRefactoring.Migrations
{
    public class InMemoryMigrationsPerformanceTest : EventStreamMutatorTestsBase
    {
        ...
        public void A_hundred_thousand_events_large_aggregate_with_four_migrations_should_load_cached_in_less_than_130_milliseconds()
        {
            ...
            TimeAsserter.Execute(
                maxAverage: 130.Milliseconds().AdjustRuntimeForNCrunch(boost:6), iterations: 10, description: "load aggregate in isolated scope",
