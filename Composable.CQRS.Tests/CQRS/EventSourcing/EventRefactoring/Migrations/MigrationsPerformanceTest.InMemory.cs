...
namespace CQRS.Tests.CQRS.EventSourcing.EventRefactoring.Migrations
{
    public class InMemoryMigrationsPerformanceTest : EventStreamMutatorTestsBase
    {
        ...
        public void A_ten_thousand_events_large_aggregate_with_four_migrations_should_load_cached_in_less_than_15_milliseconds()
        {
            ...
            TimeAsserter.Execute(
                maxAverage: 15.Milliseconds().AdjustRuntimeForNCrunch(), iterations: 10, description: "load aggregate in isolated scope", timeFormat: "fff",
