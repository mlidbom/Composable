...
namespace Composable.Tests.CQRS.EventRefactoring.When_renaming_events
{
    [TestFixture] public class With_renaming_attribute_renamer_and_then_path_renamer
    {
        ...
        [TypeId("7CDC3EB4-4778-4C0F-AC5C-7EB7A53019E3")][EventRenamedFrom(Name = "OldEvent1")] class Event1 : DomainEvent
        {
            public const string OldName = OldPath + "OldEvent1";
        }

        [TypeId("0EB6D01B-D780-45B2-8AD9-C2DCC190A916")][EventRenamedFrom(Name = "OldEvent2")] class Event2 : DomainEvent
        {
