...
#pragma warning restore CS8777 // Parameter must have a non-null value when exiting.
        ...
        public static TReturnValue ReturnNotNull<TReturnValue>(TReturnValue returnValue)
        {
            return returnValue ?? throw new NullReferenceException("The contract of this method does not allow for a null return value but the return value was null");
        }
