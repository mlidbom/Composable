...
:sectnums:
:imagesdir: ../asciidoc-diagrams
:imagesoutdir: ../_site/asciidoc-diagrams
:library: Asciidoc
...
include::_diagrams.adoc[]

== A new section

== Code samples with highlighting
