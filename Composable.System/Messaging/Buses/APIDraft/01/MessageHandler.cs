...
{
    public class MessageHandler<TImplementation>
    {
    ...
    {
        public Endpoint(params MessageHandlerGroup[] handlerGroups)
        {
            handlerGroups.ForEach(Add);
        }
    ...
    public class ForumsEndpoint : Endpoint
    {
    }
