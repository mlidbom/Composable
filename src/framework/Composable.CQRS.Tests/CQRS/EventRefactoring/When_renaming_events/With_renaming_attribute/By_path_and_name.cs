...
namespace Composable.Tests.CQRS.EventRefactoring.When_renaming_events.With_renaming_attribute
{
    ...
    public class By_path_and_name
    {
        ...
        [EventRenamedFrom(Name = OldName, Path = OldPath)] [TypeId("E81DB059-B1E5-4162-93CB-6F50ED84D37B")]class Event1 : DomainEvent
        {
        ...
        [EventRenamedFrom(Name = OldName, Path = OldPath)] [TypeId("E6F8F3A2-E234-4490-A87B-CF02A52BD8FF")]class Event2 : DomainEvent
        {
