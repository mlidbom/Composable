            ...
            _serviceLocator = DependencyInjectionContainer.CreateServiceLocatorForTesting(
                                                                                    container => container.Register(
                                                                                                                    ...
                                                                                                                    Component.For<IEventStore>()
                                                                                                                              .UsingFactoryMethod(() => new InMemoryEventStore())
                                                                                                                              .LifestyleSingleton(),
                                                                                                                    ...
                                                                                                                    Component.For<IDocumentDbReader, IVersioningDocumentDbReader>()
                                                                                                                              .UsingFactoryMethod((AccountQueryModelGenerator queryModelGenerator) => new QueryModelGeneratingDocumentDbReader(new []{queryModelGenerator}))
                                                                                                                              .LifestyleScoped(),
                                                                                                                    Component.For<AccountQueryModelGenerator> ()
                                                                                                                              .UsingFactoryMethod((IEventStoreReader eventStoreReader) => new AccountQueryModelGenerator(eventStoreReader))
                                                                                                                              .LifestyleScoped()
                                                                                                                   ));
