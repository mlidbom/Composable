...
{
    public abstract class NHibernatePersistanceSession : INHibernatePersistanceSession
    {

        private IInterceptor _interceptor;
        private ISession _session;

        protected NHibernatePersistanceSession(IInterceptor interceptor)
        {
        ...
        #region implementation of IPersistanceSession
        ...
        protected NHibernatePersistanceSession()
        {
            _instances++;
        }

        ~NHibernatePersistanceSession()
        {
            if (!_disposed)
            {
