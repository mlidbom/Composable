...
namespace Composable.CQRS.Tests.CQRS.Query.Models.AutoGenerated
{
    ...
    public class QueryModelGeneratingDocumentDbReaderTests2
    {
        ...
        {
            _container = WindsorDependencyInjectionContainerFactory.SetupForTesting(
                                                                                    container => container.Register(

                                                                                                                    CComponent.For<IEventStore>()
                                                                                                                              .ImplementedBy<InMemoryEventStore>()
                                                                                                                              .LifestyleSingleton(),
                                                                                                                    CComponent.For<IEventStoreSession, IEventStoreReader, IUnitOfWorkParticipant>()
                                                                                                                              .ImplementedBy<EventStoreSession>()
                                                                                                                              .LifestyleScoped(),
                                                                                                                    CComponent.For<IDocumentDbReader, IVersioningDocumentDbReader>()
                                                                                                                              .ImplementedBy<QueryModelGeneratingDocumentDbReader>()
                                                                                                                              .LifestyleScoped(),
                                                                                                                    CComponent.For<IQueryModelGenerator, IQueryModelGenerator<MyAccountQueryModel>>()
