...
namespace Composable.Tests.Messaging.Hypermedia
{
    public class RemoteQueryPerformanceTests : PerformanceTestBase
    {
        ...
        [Test] public void SingleThreaded_Runs_100_local_requests_making_one_ICreateMyOwnResult_query_each_in_2_milliseconds() =>
            RunScenario(threaded: false, requests: 100.EnvDivide(instrumented:1.3), queriesPerRequest: 1, maxTotal: 2.Milliseconds(), query: new ResultSelfCreatingQuery());
        ...
        [Test] public void SingleThreaded_Runs_10_local_requests_making_10_ICreateMyOwnResult_query_each_in_1_milliseconds() =>
            RunScenario(threaded: false, requests: 10.EnvDivide(instrumented:1.3), queriesPerRequest: 10, maxTotal: 1.Milliseconds(), query: new ResultSelfCreatingQuery());

        [Test] public void SingleThreaded_Runs_1_local_request_making_200_ICreateMyOwnResult_query_each_in_1_milliseconds() =>
            RunScenario(threaded: false, requests: 1, queriesPerRequest: 200.EnvDivide(instrumented:1.2), maxTotal: 1.Milliseconds(), query: new ResultSelfCreatingQuery());
        ...
        [Test] public void MultiThreaded_Runs_10_local_request_making_200_ICreateMyOwnResult_query_each_in_3_milliseconds() =>
            RunScenario(threaded: true, requests: 10, queriesPerRequest: 200.EnvDivide(instrumented: 1.2), maxTotal: 3.Milliseconds(), query: new ResultSelfCreatingQuery());
        ...
        [Test] public async Task Async_Runs_10_local_request_making_200_ICreateMyOwnResult_query_each_in_9_milliseconds() =>
            await RunAsyncScenario(requests: 10, queriesPerRequest: 200.EnvDivide(instrumented: 1.5), maxTotal: 9.Milliseconds(), query: new ResultSelfCreatingQuery());


        void RunScenario(bool threaded, int requests, int queriesPerRequest, TimeSpan maxTotal, MessageTypes.Remotable.NonTransactional.IQuery<MyQueryResult> query)
        {
        ...
        async Task RunAsyncScenario(int requests, int queriesPerRequest, TimeSpan maxTotal, MessageTypes.Remotable.NonTransactional.IQuery<MyQueryResult> query)
        {
            var navigationSpecification = NavigationSpecification.Get(query);
    ...
    class ResultSelfCreatingQuery : MessageTypes.Remotable.NonTransactional.ICreateMyOwnResultQuery<PerformanceTestBase.MyQueryResult>
    {
        public PerformanceTestBase.MyQueryResult CreateResult() => new PerformanceTestBase.MyQueryResult();
    }
}
