...
namespace Composable.Tests.CQRS
{
    ...
    public abstract class EventStoreUpdaterTests
    {
        class EventSpy
        {
            public IEnumerable<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent> DispatchedMessages => _events.ToList();
            public void Receive(MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent @event) { _events.Add(@event); }
            readonly List<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent> _events = new List<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>();
        }
        ...
        [SetUp] public void SetupBus()
        {
            ...
            ServiceLocator.Resolve<IMessageHandlerRegistrar>()
                          .ForEvent<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>(_eventSpy.Receive);
