...
namespace Composable.Persistence.MsSql.SystemExtensions
{
    static class MsSqlCommandExtensions
    {
        ...
        public static async Task<object> ExecuteScalarAsync(this SqlCommand @this, string commandText) => await @this.SetCommandText(commandText).ExecuteScalarAsync().NoMarshalling();
        ...
        public static async Task<int> ExecuteNonQueryAsync(this SqlCommand @this, string commandText) => await @this.SetCommandText(commandText).ExecuteNonQueryAsync().NoMarshalling();
