        ...
        partial class HandlerExecutionEngine
        {
            partial class Coordinator
            {
                ...
                internal class HandlerExecutionTask
                {
                    ...
                    public HandlerExecutionTask(TransportMessage.InComing transportMessage, Coordinator coordinator, ITaskRunner taskRunner, SqlServerMessageStorage messageStorage, IServiceLocator serviceLocator, IMessageHandlerRegistry handlerRegistry)
                    {
