...
CREATE TABLE dbo.{Name}(
    ...
    {SqlServerEventTable.Columns.InsertAfter} bigint null,
    {SqlServerEventTable.Columns.InsertBefore} bigint null,
    {SqlServerEventTable.Columns.Replaces} bigint null,
    ...
    CREATE NONCLUSTERED INDEX IX_{Name}_{SqlServerEventTable.Columns.Replaces}	ON dbo.{Name}
        ...
        INCLUDE ({SqlServerEventTable.Columns.InsertionOrder})
