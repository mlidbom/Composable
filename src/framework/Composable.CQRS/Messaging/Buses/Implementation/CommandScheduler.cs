...
namespace Composable.Messaging.Buses.Implementation
{
    class CommandScheduler : IDisposable
    {
        ...
        public void Schedule(DateTime sendAt, BusApi.RemoteSupport.ExactlyOnce.ICommand message) => _guard.Update(() =>
        {
        ...
        class ScheduledCommand
        {
            ...
            public BusApi.RemoteSupport.ExactlyOnce.ICommand Command { get; }

            public ScheduledCommand(DateTime sendAt, BusApi.RemoteSupport.ExactlyOnce.ICommand command)
            {
