...
namespace CQRS.Tests.CQRS.EventSourcing.EventRefactoring.Migrations
{
    public class After<TEvent> : EventMigration<IRootEvent>
    {
        ...
        public static After<TEvent> Insert<T1, T2>() => new After<TEvent>(Seq.OfTypes<T1, T2>());//Write test that uses this. We should have a test replacing with a collection.
