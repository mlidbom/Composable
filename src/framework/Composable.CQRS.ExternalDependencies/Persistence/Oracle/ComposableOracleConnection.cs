...
namespace Composable.Persistence.Oracle
{
    ...
    class ComposableOracleConnection : IComposableOracleConnection
    {
        IDbConnection IComposableDbConnection.Connection => Connection;
        internal OracleConnection Connection { get; }

        ComposableOracleConnection(string connectionString) => Connection = new OracleConnection(connectionString);
