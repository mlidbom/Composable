...
{
    public class ResourceAccessGuard_SharedAccessResourceGuard_specification
    {
        [Fact] public void When_one_thread_has_ExclusiveLock_other_thread_requesting_exclusive_lock_is_blocked_until_first_thread_disposes_lock()
        {
        ...
        [Fact] public void When_one_thread_calls_AwaitExclusiveLock_twice_other_thread_requesting_exclusive_lock_is_blocked_until_first_thread_disposes_both_locks()
        {
            var resourceGuard = ResourceAccessGuard.CreateWithMaxSharedLocksAndTimeout(10, 1.Seconds());
