    ...
    public static partial class BusApi
    {
        internal static class Internal
        {
            ...
            internal class EndpointInformation
            {
                ...
                public EndpointInformation(IEnumerable<TypeId> handledRemoteMessageTypeIds) => HandledMessageTypes = new HashSet<TypeId>(handledRemoteMessageTypeIds);
            ...
            public static void RegisterHandlers(MessageHandlerRegistrarWithDependencyInjectionSupport registrar) => registrar.ForQuery(
                (EndpointInformationQuery query, TypeMapper typemapper, IMessageHandlerRegistry registry) =>
                {
                    return new EndpointInformation(registry.HandledRemoteMessageTypeIds());
                });
