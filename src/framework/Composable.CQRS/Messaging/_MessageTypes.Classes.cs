...
#pragma warning disable CA1724 //Class name conflicts with namespace name.
                public abstract class StrictlyLocalQuery<TQuery, TResult> : MessageTypes.IStrictlyLocalQuery<TQuery, TResult> where TQuery : StrictlyLocalQuery<TQuery, TResult> {}
#pragma warning restore CA1724 //
            ...
            {
                public abstract class StrictlyLocalCommand : MessageTypes.IStrictlyLocalCommand {}

                public abstract class StrictlyLocalCommand<TResult> : MessageTypes.IStrictlyLocalCommand<TResult> {}
            }
        }
        ...
        public static partial class Remotable
        {
            public static partial class AtMostOnce
            {
                ...
                public class AtMostOnceHypermediaCommand : MessageTypes.IAtMostOnceHypermediaCommand
                {
                ...
                public class AtMostOnceCommand<TResult> : AtMostOnceHypermediaCommand, MessageTypes.IAtMostOnceCommand<TResult>
                {
            ...
            public static partial class NonTransactional
            {
                ...
                {
#pragma warning disable CA1724 //Class name conflicts with namespace name.
                    public abstract class Query<TResult> : MessageTypes.IRemotableQuery<TResult> {}
#pragma warning restore CA1724 //Class name conflicts with namespace name.
            ...
            {
                public class Command : ValueObject<Command>, MessageTypes.IExactlyOnceCommand
                {
        ...
        {
            typeMapper
               .MapTypeAndStandardCollectionTypes<MessageTypes.IRemotableEvent>("1E0DB1B4-71A6-4D2E-901F-E238ABA30B63")
