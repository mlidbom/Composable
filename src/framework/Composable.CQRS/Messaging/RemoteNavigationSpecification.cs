...
namespace Composable.Messaging
{
    public abstract class RemoteNavigationSpecification
    {
        ...
        public static RemoteNavigationSpecification PostRemote(MessagingApi.Remote.ExactlyOnce.ICommand command) => new RemoteNavigationSpecification.Remote.VoidCommand(command);
        public static RemoteNavigationSpecification<TResult> PostRemote<TResult>(MessagingApi.Remote.ExactlyOnce.ICommand<TResult> command) => new RemoteNavigationSpecification<TResult>.Remote.StartCommand(command);
        ...
        internal static class Remote
        {
            ...
            {
                readonly MessagingApi.Remote.ExactlyOnce.ICommand _command;

                public VoidCommand(MessagingApi.Remote.ExactlyOnce.ICommand command) => _command = command;
