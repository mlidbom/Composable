...
namespace Composable.Persistence.InMemory.DocumentDB
{
    ...
    class InMemoryDocumentDbPersistenceLayer : IDocumentDbPersistenceLayer
    {
        ...
        public int Remove(string idString, IReadOnlyList<Guid> acceptableTypeIds) => throw new NotImplementedException();
        public IEnumerable<Guid> GetAllIds(IReadOnlyList<Guid> acceptableTypeIds) => throw new NotImplementedException();
        public IReadOnlyList<IDocumentDbPersistenceLayer.ReadRow> GetAll(IEnumerable<Guid> ids, IReadOnlyList<Guid> getAcceptableTypes) => throw new NotImplementedException();
