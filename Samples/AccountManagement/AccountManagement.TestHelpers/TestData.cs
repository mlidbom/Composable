namespace AccountManagement.TestHelpers
{
    public class TestData
    {
        public static class Password
        {
            ...
            {
                public static string[] All = {Null, ShorterThanFourCharacters, BorderedByWhiteSpaceAtBeginning, BorderedByWhiteSpaceAtEnd, MissingUpperCaseCharacter, MissingLowercaseCharacter};
