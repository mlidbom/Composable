...
namespace Composable.Tests.CQRS.EventRefactoring.Migrations
{
    ...
    public class EventMigrationPerformanceTest : EventMigrationTestBase
    {
        ...
        [Test]
        public void With_four_migrations_mutation_that_all_actually_changes_things_uncached_loading_takes_less_than_25_milliseconds_cached_less_than_5_milliseconds()
        {
            ...
            AssertUncachedAggregateLoadTime(25.Milliseconds().InstrumentationSlowdown(2), 5.Milliseconds().InstrumentationSlowdown(2.5), eventMigrations);
        }

        [Test]
        public void With_four_migrations_that_change_nothing_uncached_loading_takes_less_than_30_milliseconds_cached_less_than_5_milliseconds()
        {
            var eventMigrations = Seq.Create<IEventMigration>(
                Before<E3>.Insert<E1>(),
                Before<E5>.Insert<E1>(),
            ...
            AssertUncachedAggregateLoadTime(30.Milliseconds().InstrumentationSlowdown(2), 5.Milliseconds().InstrumentationSlowdown(2), eventMigrations);
        }
