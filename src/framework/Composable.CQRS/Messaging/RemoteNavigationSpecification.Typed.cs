...
namespace Composable.Messaging
{
    public abstract partial class RemoteNavigationSpecification<TResult>
    {
        ...
        public RemoteNavigationSpecification<TNext> GetRemote<TNext>(Func<TResult, IQuery<TNext>> next) => new RemoteNavigationSpecification<TNext>.Remote.ContinuationQuery<TResult>(this, next);
        public RemoteNavigationSpecification<TNext> PostRemote<TNext>(Func<TResult, IExactlyOnceCommand<TNext>> next) => new RemoteNavigationSpecification<TNext>.Remote.PostCommand<TResult>(this, next);
        public RemoteNavigationSpecification PostRemote(Func<TResult, IExactlyOnceCommand> next) => new Remote.PostVoidCommand<TResult>(this, next);
