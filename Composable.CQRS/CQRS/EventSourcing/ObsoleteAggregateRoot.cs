...
namespace Composable.CQRS.EventSourcing
{
    ...
    public class ObsoleteAggregateRoot<TEntity> : VersionedPersistentEntity<TEntity>, IEventStored, ISharedOwnershipAggregateRoot where TEntity : ObsoleteAggregateRoot<TEntity>
    {
        ...
        protected ObsoleteAggregateRoot() : base(Guid.Empty) { }
        ...
        protected void ApplyEvent<TThis, TEvent>(TThis _this, TEvent evt)
            where TThis : IEventApplier<TEvent>
