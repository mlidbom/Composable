...
{
    public partial class Given_a_backend_endpoint_with_command_event_and_query_handlers
    {
        public class Paralellism_policies : Given_a_backend_endpoint_with_command_event_and_query_handlers
        {
