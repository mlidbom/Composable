...
namespace Composable.Tests.SystemCE.ThreadingCE.ResourceAccess
{
    public class MonitorCEPerformanceTests
    {
        ...
        [Test] public void _031_Read_MonitorCE_Using_EnterLock______time_is_less_than_nanoseconds_SingleThreaded_45_MultiThreaded_270() =>
            RunScenarios(() => _guarded.Read_MonitorCE_Using_EnterLock(),
                         singleThread: (45 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 45, unoptimized: 2.2),
                         multiThread: (270 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 14, unoptimized:1.4));

        [Test] public void _032_Read_MonitorCE_Read________________time_is_less_than_nanoseconds_SingleThreaded_70_MultiThreaded_290() =>
            RunScenarios(() => _guarded.Read_MonitorCE_Read(),
                         singleThread: (70 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 30.0, unoptimized: 2.2),
                         multiThread: (290 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 9.0, unoptimized:1.6));
        ...
        [Test] public void _060_Increment_Locked___________________________________time_is_less_than_nanoseconds_SingleThreaded_25__MultiThreaded_280() =>
            RunScenarios(() => _guarded.Increment_Locked(),
                         ...
                         multiThread: (280 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 3.0));

        [Test] public void _070_Increment_MonitorCE_Using_EnterLock_________________time_is_less_than_nanoseconds_SingleThreaded_40__MultiThreaded_270() =>
            RunScenarios(() => _guarded.Increment_MonitorCE_Using_EnterLock(),
                         singleThread: (40 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 40, unoptimized: 2.2),
                         multiThread: (270 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 8.0, unoptimized: 1.3));

        [Test] public void _071_Increment_MonitorCE_Using_EnterNotifyOneUpdateLock___time_is_less_than_nanoseconds_SingleThreaded_40__MultiThreaded_300() =>
            RunScenarios(() => _guarded.Increment_MonitorCE_Using_EnterNotifyOneUpdateLock(),
                         singleThread: (40 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 45, unoptimized: 2.8),
                         multiThread: (300 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 10, unoptimized: 1.3));

        [Test] public void _072_Increment_MonitorCE_Using_EnterNotifyAllUpdateLock____time_is_less_than_nanoseconds_SingleThreaded_45__MultiThreaded_270() =>
            RunScenarios(() => _guarded.Increment_MonitorCE_Using_EnterNotifyAllUpdateLock(),
                         singleThread: (45 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 45, unoptimized: 2.8),
                         multiThread: (270 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 8, unoptimized: 1.3));

        [Test] public void _073_Increment_MonitorCE_Update_________________________time_is_less_than_nanoseconds_SingleThreaded_70__MultiThreaded_300() =>
            RunScenarios(() => _guarded.Increment_MonitorCE_Update(),
                         singleThread: (70 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 32, unoptimized: 1.8),
                         multiThread: (300 * TotalLocks).Nanoseconds().EnvMultiply(instrumented: 12, unoptimized: 1.3));
