...
namespace Composable.Tests.Messaging.APIDraft.Policyv2
{
    ...
    {
        void Configure(IHandlerPolicyConfigurationBuilder builder, MessagingApi.IMessage message);
    }
    ...
    class CompositePolicy : IMessageHandlerPolicy
    {
        ...
        public void Configure(IHandlerPolicyConfigurationBuilder builder, MessagingApi.IMessage message) { throw new NotImplementedException(); }
    }
}
