...
namespace Composable.Messaging.Buses
{
    class MessageHandlerRegistry : IMessageHandlerRegistrar, IMessageHandlerRegistry
    {
        ...
        readonly Dictionary<Type, List<Action<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>>> _eventHandlers = new Dictionary<Type, List<Action<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>>>();
        ...
        IMessageHandlerRegistrar IMessageHandlerRegistrar.ForEvent<TEvent>(Action<TEvent> handler)
        {
            ...
            lock(_lock)
            {
                Assert.Argument.Assert(!(typeof(TEvent)).IsAssignableFrom(typeof(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand)), !(typeof(TEvent)).IsAssignableFrom(typeof(MessagingApi.IQuery)));
                _eventHandlers.GetOrAdd(typeof(TEvent), () => new List<Action<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>>()).Add(@event => handler((TEvent)@event));
        ...
        IMessageHandlerRegistrar IMessageHandlerRegistrar.ForCommand<TCommand>(Action<TCommand> handler)
        {
            ...
            if(typeof(TCommand).Implements(typeof(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand<>)))
            {
            ...
            lock(_lock)
            {
                Assert.Argument.Assert(!(typeof(TCommand)).IsAssignableFrom(typeof(MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent)), !(typeof(TCommand)).IsAssignableFrom(typeof(MessagingApi.IQuery)));
                _commandHandlers.Add(typeof(TCommand), command => handler((TCommand)command));
                return this;
            }
        }

        public IMessageHandlerRegistrar ForCommand<TCommand, TResult>(Func<TCommand, TResult> handler) where TCommand : MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand<TResult>
        {
            MessageInspector.AssertValid<TCommand>();
            lock (_lock)
            {
        ...
        IMessageHandlerRegistrar IMessageHandlerRegistrar.ForQuery<TQuery, TResult>(Func<TQuery, TResult> handler)
        {
            ...
            lock(_lock)
            {
                Assert.Argument.Assert(!(typeof(TQuery)).IsAssignableFrom(typeof(MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent)), !(typeof(TQuery)).IsAssignableFrom(typeof(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand)));
                _queryHandlers.Add(typeof(TQuery), query => handler((TQuery)query));
                return this;
            }
        }

        Action<object> IMessageHandlerRegistry.GetCommandHandler(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand message)
        {
        ...
        public bool TryGetCommandHandler(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand message, out Action<object> handler)
        {
            lock(_lock)
            {
        ...
        public bool TryGetCommandHandlerWithResult(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand message, out Func<object, object> handler)
        {
            lock(_lock)
            {
        ...
        public Func<MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand, object> GetCommandHandler(Type commandType)
        {
        ...
        public IReadOnlyList<Action<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>> GetEventHandlers(Type eventType)
        {
        ...
        public Func<MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand<TResult>, TResult> GetCommandHandler<TResult>(MessagingApi.Remote.ExactlyOnce.IExactlyOnceCommand<TResult> command)
        {
            try
            {
                lock (_lock)
        ...
        IEventDispatcher<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent> IMessageHandlerRegistry.CreateEventDispatcher()
        {
            var dispatcher = new CallMatchingHandlersInRegistrationOrderEventDispatcher<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>();
            var registrar = dispatcher.RegisterHandlers()
                                      .IgnoreUnhandled<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>();
            lock(_lock)
            {
        ...
        internal class EventHandlerRegistration
        {
            ...
            public Action<IEventHandlerRegistrar<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>> RegisterHandlerWithRegistrar { get; }
            public EventHandlerRegistration(Type type, Action<IEventHandlerRegistrar<MessagingApi.Remote.ExactlyOnce.IExactlyOnceEvent>> registerHandlerWithRegistrar)
            {
                Type = type;
