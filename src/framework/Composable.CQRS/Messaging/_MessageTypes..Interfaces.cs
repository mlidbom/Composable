...
namespace Composable.Messaging
{
    public static partial class MessageTypes
    {
        ...
        public interface IStrictlyLocalEvent : MessageTypes.IEvent, MessageTypes.IStrictlyLocalMessage {}
        public interface IStrictlyLocalCommand : MessageTypes.ICommand, MessageTypes.IMustBeSentTransactionally, MessageTypes.IStrictlyLocalMessage {}
        public interface IStrictlyLocalCommand<out TResult> : MessageTypes.ICommand<TResult>, MessageTypes.IStrictlyLocalCommand {}
        public interface IStrictlyLocalQuery<TQuery, out TResult> : MessageTypes.IQuery<TResult>, MessageTypes.IStrictlyLocalMessage where TQuery : IStrictlyLocalQuery<TQuery, TResult> {}

        //Todo: Why do we need both Remotable and Strictly local?
        public interface IRemotableMessage : MessageTypes.IMessage {}
        public interface IRemotableEvent : MessageTypes.IRemotableMessage, MessageTypes.IEvent {}
        public interface IRemotableCommand : MessageTypes.ICommand, MessageTypes.IRemotableMessage {}
        public interface IRemotableCommand<out TResult> : MessageTypes.IRemotableCommand, MessageTypes.ICommand<TResult> {}
        public interface IRemotableQuery<out TResult> : MessageTypes.IRemotableMessage, MessageTypes.IQuery<TResult> {}
        public interface IRemotableCreateMyOwnResultQuery<out TResult> : MessageTypes.IRemotableQuery<TResult>, MessageTypes.ICreateMyOwnResultQuery<TResult> {}
        ...
        public interface IAtMostOnceMessage : MessageTypes.IRemotableMessage, MessageTypes.IMustBeHandledTransactionally
        {
        ...
        public interface IAtMostOnceHypermediaCommand : IAtMostOnceMessage, MessageTypes.IRemotableCommand, MessageTypes.IHypermediaMessage {}
        public interface IAtMostOnceCommand<out TResult> : MessageTypes.IAtMostOnceHypermediaCommand, MessageTypes.IRemotableCommand<TResult> {}


        public interface IExactlyOnceMessage : MessageTypes.IMustBeSentAndHandledTransactionally, MessageTypes.IAtMostOnceMessage {}
        ...
        public interface IExactlyOnceEvent : MessageTypes.IRemotableEvent, MessageTypes.IExactlyOnceMessage {}
        public interface IExactlyOnceCommand : MessageTypes.IRemotableCommand, MessageTypes.IExactlyOnceMessage {}
        ...
        public interface IExactlyOnceWrapperEvent<out TEventInterface> : MessageTypes.IWrapperEvent<TEventInterface>, MessageTypes.IExactlyOnceEvent
...
#pragma warning disable CA1033 // Interface methods should be callable by child types: This should be used by infrastructure only. End user code and inheritors should never need to implement it and implementing it in any other way would be a bug.
            Guid MessageTypes.IAtMostOnceMessage.MessageId => Event.MessageId;
