...
namespace Composable.Persistence.Oracle.SystemExtensions
{
    static class OracleCommandParameterExtensions
    {
        ...
        public static OracleCommand AddParameter(this OracleCommand @this, string name, Guid value) => AddParameter(@this, name, OracleDbType.Char, value.ToString(), 39);
        public static OracleCommand AddParameter(this OracleCommand @this, string name, DateTime value) => AddParameter(@this, name, OracleDbType.TimeStamp, value);
        ...
        public static OracleCommand AddNClobParameter(this OracleCommand @this, string name, string value) => AddParameter(@this, name, OracleDbType.NClob, value);
