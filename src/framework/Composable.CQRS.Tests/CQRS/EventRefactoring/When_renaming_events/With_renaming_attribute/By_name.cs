...
namespace Composable.Tests.CQRS.EventRefactoring.When_renaming_events.With_renaming_attribute
{
    ...
    [EventRenamedFrom(Name = OldName)] [TypeId("A06FF121-825D-452F-AB39-C9F18BBAECBC")]class Event1 : AggregateRootEvent
    {
        const string OldName = "Even1OldName";
        public static readonly string OldFullName = $"{typeof(Event1).Namespace}.{OldName}";
    }

    [EventRenamedFrom(Name = OldName)] [TypeId("53068F60-B4FF-4BA4-9663-2B23A5ED2F92")]class Event2 : AggregateRootEvent
    {
