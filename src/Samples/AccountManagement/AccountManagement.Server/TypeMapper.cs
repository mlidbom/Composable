    ...
    static class TypeMapper
    {
        ...
        public static void MapTypes(ITypeMappingRegistar typeMapper)
        {
            typeMapper
               ...
               .Map<API.AccountResource.Commands.LogIn.UI>("90689406-de88-43da-be17-0fb93692f6ad")
               .Map<Composable.Messaging.EntityByIdQuery<API.AccountResource>>("bc9a5aa6-bbbc-4e0f-841f-ad77d40a483f")
               .Map<PrivateAccountApi.Query.TryGetByEmailQuery>("4cf7d647-e5cf-4961-989c-e9f128207a9e")
               ...
               .Map<Composable.Messaging.EntityByIdQuery<Domain.Account>>("e5648606-0d8b-450e-8eec-a66899b7e12a")
               .Map<Composable.Messaging.PersistEntityCommand<Domain.Account>>("01b66bcb-1a39-4bb0-8344-444349ee0790")
               .Map<Composable.Messaging.ReadonlyCopyOfEntityByIdQuery<Domain.Account>>("b57e938c-254e-4f0a-9afd-b4cfef228189")
               .Map<Composable.Messaging.ReadonlyCopyOfEntityVersionByIdQuery<Domain.Account>>("9b5ef7b2-cbc6-46a5-a1d0-2400b1cc0951");
        }
    }
}
