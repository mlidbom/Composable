...
namespace Composable.Persistence.Oracle.SystemExtensions
{
    static class OracleCommandParameterExtensions
    {
        ...
        public static OracleCommand AddParameter(this OracleCommand @this, string name, Guid value) => AddParameter(@this, name, OracleDbType.Char, value, 39);
        ...
        public static OracleCommand AddNClobParameter(this OracleCommand @this, string name, string value) => AddParameter(@this, name, OracleDbType.NClob, value, -1);
