    ...
    public class QueryModelGeneratingDocumentDbReaderTests
    {
        ...
        public void CreateContainer()
        {
            _serviceLocator = DependencyInjectionContainer.CreateServiceLocatorForTesting(
                endpointBuilder => endpointBuilder.Container.Register(
                    Singleton.For<IEventStore>().CreatedBy(() => new InMemoryEventStore()),
                    Scoped.For<IEventStoreUpdater, IEventStoreReader>().CreatedBy((IEventStoreEventPublisher eventPublisher, IEventStore eventStore, IUtcTimeTimeSource timeSource, IAggregateTypeValidator aggregateTypeValidator) => new EventStoreUpdater(eventPublisher, eventStore, timeSource, aggregateTypeValidator)),
