    ...
    public abstract class EventMigrationTest : EventMigrationTestBase
    {
        ...
        public void UpdatingAnAggregateAfterPersistingMigrations()
        {
            ...
            try
            {
                ...
                var completeEventHistory =serviceLocator.ExecuteInIsolatedScope(() => EventStore().ListAllEventsForTestingPurposesAbsolutelyNotUsableForARealEventStoreOfAnySize()).Cast<DomainEvent>();
                ...
                completeEventHistory = serviceLocator.ExecuteInIsolatedScope(() => EventStore().ListAllEventsForTestingPurposesAbsolutelyNotUsableForARealEventStoreOfAnySize()).Cast<DomainEvent>();
                AssertStreamsAreIdentical(expected: expected, migratedHistory: completeEventHistory, descriptionOfHistory: "streamed persisted history");
            }
            finally
            {
