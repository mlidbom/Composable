    ...
    static class TypeMapper
    {
        ...
        public static void MapTypes(ITypeMappingRegistar typeMapper)
        {
            typeMapper
               ...
               .Map<EventStoreApi.Query.AggregateLink<API.AccountResource>>("bc9a5aa6-bbbc-4e0f-841f-ad77d40a483f")
               ...
               .Map<Composable.Messaging.MessagingApi.Remote.Query.RemoteEntityResourceQuery<API.AccountResource>>("93292073-d1d2-40b3-9d89-66781a19de7b")
               ...
               .Map<DocumentDbApi.Query.GetReadonlyCopyOfDocument<EventStoreApi.Query.AggregateLink<AccountManagement.Domain.Account>>>("a25c12f1-ecd8-438a-8c35-e37b89387c19")
               .Map<DocumentDbApi.Command.SaveDocument<EventStoreApi.Query.AggregateLink<AccountManagement.Domain.Account>>>("bf279875-50b9-49d6-b66d-8717ce863a01");
        }
    }
}
