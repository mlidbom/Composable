...
{
    public class QueryModelGeneratingDocumentDbReaderTests : NSpec.NUnit.nspec
    {
        ...
        public class DogGenerator : IQueryModelGenerator<Dog>
        {
        ...
        public class CatGenerator : IQueryModelGenerator<Cat>
        {
