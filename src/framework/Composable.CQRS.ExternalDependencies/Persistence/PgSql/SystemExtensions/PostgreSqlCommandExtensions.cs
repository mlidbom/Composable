...
namespace Composable.Persistence.PgSql.SystemExtensions
{
    static class MyNpgsqlCommandExtensions
    {
        ...
        public static async Task<object> ExecuteScalarAsync(this NpgsqlCommand @this, string commandText) => await @this.SetCommandText(commandText).ExecuteScalarAsync();
        ...
        public static async Task<int> ExecuteNonQueryAsync(this NpgsqlCommand @this, string commandText) => await @this.SetCommandText(commandText).ExecuteNonQueryAsync();
