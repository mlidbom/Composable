...
namespace Composable.Tests.ExternalDependencies.DatabasePoolTests
{
    ...
    public class DatabasePoolPerformanceTests : DatabasePoolTest
    {
        ...
        [Test]
        public void Once_DB_Fetched_Can_use_100_connections_in_milliseconds_MsSql_5_MySql_30_PgSql_1_Oracle_10_db2_40()
        {
            using var manager = CreatePool();
            manager.SetLogLevel(LogLevel.Warning);
           ...
           TimeAsserter.Execute(
               ...
               maxTotal: TestEnvironment.ValueForPersistenceProvider(msSql:5, mySql: 30, pgSql:1, orcl:10, db2: 40).Milliseconds()
           );
        }
    }
}
