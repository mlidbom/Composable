        ...
        public static partial class Remotable
        {
            public static partial class AtMostOnce
            {
                ...
                public class Command : Remotable.AtMostOnce.ICommand
                {
                    ...
                    ///<summary>How and when a <see cref="DeduplicationId"/> is generated is vital to correctly maintain the At most once delivery guarantee.
                    ///When creating the command in the backend service we must generate a new <see cref="DeduplicationId"/>.
                    ///When binding the command in a UI we MUST reuse the <see cref="DeduplicationId"/> generated by the backend.
                    ///Ensure that you design your inheriting class with this in mind or the guarantee will be lost.</summary>
