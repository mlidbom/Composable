...
namespace Composable.Tests.Messaging.ServiceBusSpecification.Performance
{
    ...
    {
        [Test] public void Runs_10000_MultiThreaded_local_queries_in_20_milliSecond()
        {
            //Warmup
            ...
            TimeAsserter.ExecuteThreaded(action: () => ServerEndpoint.ServiceLocator.ExecuteInIsolatedScope(() => ServerBusSession.Execute(new MyLocalQuery())), iterations: 10000, maxTotal: 20.Milliseconds(), maxTries: 1);
        }
