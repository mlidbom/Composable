...

{
    public class DocumentDbApi
    {
        ...
        public class Query
        {
            ...
            public class DocumentLink<TEntity> : MessagingApi.Remote.ExactlyOnce.Message, MessagingApi.IQuery<TEntity>
            {
            ...
            public class TryGetDocument<TEntity> : MessagingApi.Remote.ExactlyOnce.Message, MessagingApi.IQuery<TEntity>
            {
            ...
            public class GetReadonlyCopyOfDocument<TEntity> : MessagingApi.Remote.ExactlyOnce.Message, MessagingApi.IQuery<TEntity>
            {
            ...
            public class GetReadonlyCopyOfDocumentVersion<TEntity> : MessagingApi.Remote.ExactlyOnce.Message, MessagingApi.IQuery<TEntity>
            {
        ...
        public class Command
        {
            ...
            public class SaveDocument<TEntity> : MessagingApi.Remote.ExactlyOnce.Command
            {
